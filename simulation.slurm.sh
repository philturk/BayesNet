...
#SBATCH --output=Jobs/simulation-%j-%A-%a.out      #output file (with job ID %j, array job %A, array ID %a)
#SBATCH --error=Jobs/simulation-%j-%A-%a.err       #error file (with job ID %j, array job %A, array ID %a)
