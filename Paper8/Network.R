...
Distances <- read.csv("C:\\Users\\Gabby\\Documents\\grad_school\\GRA_nicole_carnegie\\Genetic_Network_Sampling\\distances_0.02.csv",
                      stringsAsFactors=FALSE)

#import ID key CSV
#ID, Sequences
#ID is either ###v######## or ###-###
IDs <- read.csv("C:\\Users\\Gabby\\Documents\\grad_school\\GRA_nicole_carnegie\\Genetic_Network_Sampling\\ids.csv")
#1259 unique IDs
