...
write.csv(df_95, paste0(file_location, "//proportions//prop95-comp_dist.csv"), row.names = FALSE)
write.csv(df_9, paste0(file_location, "//proportions//prop90-comp_dist.csv"), row.names = FALSE)
write.csv(df_85, paste0(file_location, "//proportions//prop85-comp_dist.csv"), row.names = FALSE)
write.csv(df_8, paste0(file_location, "//proportions//prop80-comp_dist.csv"), row.names = FALSE)
write.csv(df_75, paste0(file_location, "//proportions//prop75-comp_dist.csv"), row.names = FALSE)
write.csv(df_7, paste0(file_location, "//proportions//prop70-comp_dist.csv"), row.names = FALSE)
write.csv(df_65, paste0(file_location, "//proportions//prop65-comp_dist.csv"), row.names = FALSE)
write.csv(df_6, paste0(file_location, "//proportions//prop60-comp_dist.csv"), row.names = FALSE)
write.csv(df_55, paste0(file_location, "//proportions//prop55-comp_dist.csv"), row.names = FALSE)
write.csv(df_5, paste0(file_location, "//proportions//prop50-comp_dist.csv"), row.names = FALSE)
write.csv(df_45, paste0(file_location, "//proportions//prop45-comp_dist.csv"), row.names = FALSE)
write.csv(df_4, paste0(file_location, "//proportions//prop40-comp_dist.csv"), row.names = FALSE)
write.csv(df_35, paste0(file_location, "//proportions//prop35-comp_dist.csv"), row.names = FALSE)
write.csv(df_3, paste0(file_location, "//proportions//prop30-comp_dist.csv"), row.names = FALSE)
write.csv(df_25, paste0(file_location, "//proportions//prop25-comp_dist.csv"), row.names = FALSE)
write.csv(df_2, paste0(file_location, "//proportions//prop20-comp_dist.csv"), row.names = FALSE)
write.csv(df_all_sim, paste0(file_location, "//proportions//df_all_sim-comp_dist.csv"), row.names = FALSE)
write.csv(df_only_95, paste0(file_location, "//proportions//df_only_95-comp_dist.csv"), row.names = FALSE)
